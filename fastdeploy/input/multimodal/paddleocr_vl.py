...
"""PaddleOCR-VL multimodal processor.

Inherits from QwenVLProcessor and overrides methods that differ:
- _make_outputs: add vit_seqlen / vit_position_ids
- add_image / add_video: append vit_fields
...
class PaddleOCRVLProcessor(QwenVLProcessor):
    ...
    Inherits from QwenVLProcessor and overrides methods where PaddleOCR
    differs: vit fields, video_token_id usage, and video frame sampling.
    """

    # ------------------------------------------------------------------
    # Class attributes (from mm_model_config PADDLEOCR_VL)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Video loading (PaddleOCR uses different frame sampling)
    # ------------------------------------------------------------------
